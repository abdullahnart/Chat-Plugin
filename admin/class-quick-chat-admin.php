...
class Quick_Chat_Admin {
	...
	public function __construct( $plugin_name, $version ) {
		...
		add_action('admin_menu', [$this, 'quick_chat_admin_shortcode']);
	...
	public function quick_chat_admin_shortcode(){
		add_menu_page('Instant Chat Assistant','Instant Chat','manage_options','add_shortcode',[$this,'shortcode_func'],'dashicons-format-chat', 25);

	}

	public function shortcode_func(){
		return include_once plugin_dir_path(__FILE__) . 'partials/quick-chat-admin-display.php';
	}
